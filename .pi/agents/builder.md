...
If you encounter a git merge conflict, stop immediately and report: CONFLICT: <list of conflicting files>. Do not attempt to resolve merge conflicts yourself.
